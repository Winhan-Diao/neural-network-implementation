...
void mnist() {
    Network n(28*28, 10, std::vector{100, 20}, std::vector{ActivationFunctions::PRRELU, ActivationFunctions::PRRELU}, ActivationFunctions::SOFTMAX, LossFunctions::CROSS_ENTROPY_LOSS);
